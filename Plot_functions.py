...
def validation_plot_quarter_with_year(quarter, dataframe, val_year):
    ...
    if quarter == 'All':
      ...
      # Plot the predicted temperature
        ...
        # Set the layout
        fig.update_layout(
            title= f'Validation predictions vs True Temperatures (4th Quarter of  {val_year})',
            xaxis_title='Date',
            yaxis_title='T (degC)',
            legend_title_text='',
            font=dict(
...
def validation_plot_quarter_no_year(quarter, dataframe):
    ...
    if quarter == 'All':
      ...
      # Plot the predicted temperature
        ...
        # Set the layout
        fig.update_layout(
            title= f'Validations predictions vs True Temperatures (1st Quarter of the sample)',
            xaxis_title='Date',
            yaxis_title='T (degC)',
            legend_title_text='',
            font=dict(
      ...
      # Plot the predicted temperature
        ...
        #    TEST
def test_plot_quarter_no_year(quarter, dataframe):
    q_len = 0.25
    ...
    if quarter == 'All':
      ...
      # Plot the predicted temperature
        ...
        # Set the layout
        fig.update_layout(
            title= f'Test predictions vs True Temperatures',
            xaxis_title='Date',
            yaxis_title='T (degC)',
            legend_title_text='',
            font=dict(
      ...
      # Plot the predicted temperature
        ...
        # Set the layout
        fig.update_layout(
            title= f'Test predictions vs True Temperatures (1st Quarter of the sample)',
            xaxis_title='Date',
            yaxis_title='T (degC)',
            legend_title_text='',
            font=dict(
      ...
      # Plot the predicted temperature
        ...
        # Set the layout
        fig.update_layout(
            title='Test predictions vs True Temperatures (2nd Quarter of the sample)',
            xaxis_title='Date',
            yaxis_title='T (degC)',
            legend_title_text='',
            font=dict(
      ...
      # Plot the predicted temperature
        ...
        # Set the layout
        fig.update_layout(
            title='Test predictions vs True Temperatures (3rd Quarter of the sample)',
            xaxis_title='Date',
            yaxis_title='T (degC)',
            legend_title_text='',
            font=dict(
      ...
      # Plot the predicted temperature
        ...
        # Set the layout
        fig.update_layout(
            title='Test predictions vs True Temperatures (4th Quarter of the sample)',
            xaxis_title='Date',
            yaxis_title='T (degC)',
            legend_title_text='',
            font=dict(
